...
public class ApiStart2Test extends RootTest {
	...
	public void test_getBasicShipDatas() {
		...
		List<BasicShipData> list = apiStart2.getBasicShipDatas();
	...
	public void test_getBasicShipDataMap() {
		Map<Integer, BasicShipData> map = apiStart2.getBasicShipDataMap();
	...
	public void test_getShipGraphs() {
		List<ShipGraph> list = apiStart2.getShipGraphs();
	...
	public void test_getShipGraphMap() {
		Map<Integer, ShipGraph> map = apiStart2.getShipGraphMap();
	...
	public void test_joinedShipGraph() {
		Map<Integer, Pair<Optional<BasicShipData>, Optional<ShipGraph>>> map = apiStart2.joinedShipGraph();
		map.forEach((i, pair) -> {
